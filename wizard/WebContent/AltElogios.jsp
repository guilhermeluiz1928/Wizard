...
<body>
	...
	<div class="container">
		...
		<form action="AltElogios" method="POST" name="frm"
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label class="corpo" id="labelElogiado">Elogiado</label> <input
						...
						value="<%=request.getParameter("elogiado")%>">
				</div>
				<div class="form-group col-md-6">
			...
			<div class="form-row">
				...
				<textarea class="form-control" name="elogio" rows="5"  maxlength="290"><%=request.getParameter("elogio")%></textarea>
			</div>
