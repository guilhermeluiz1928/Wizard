	...
	<div class="container">
		...
		<div class="row">
			<%
				...
				Elogios elogio = new Elogios();
				ElogiosDao elogioDao = new ElogiosDao();
				List<Elogios> lst = elogiosDao.listar();
			%>
			...
			<table class="table">
				<thead>
					<tr>
						<th colspan="1" class="text-center">Elogiado</th>
						<th colspan="1" class="text-center">Autor</th>
						<th colspan="1" class="text-center">Elogio</th>
				...
				<tbody id="tabela">
					...
					<tr>
						<td class="text-center"><%=elogio.getElogiado()%></td>
						<td class="text-center"><%=elogio.getAutor()%></td>
						<td class="text-center"><%=elogio.getElogio()%></td>
						<td align="right">
							<button type="button" class="btn btn-primary"
								onclick="parent.location.href='./AltElogios.jsp?id=<%=elogio.getId()%>&elogiado=<%=utils.encodeUrl(elogio.getElogiado())%>&autor=<%=utils.encodeUrl(elogio.getAutor())%>&elogio=<%=utils.encodeUrl(elogio.getElogio())%>'"
								type="submit">Alterar</button>
							<button type="button" class="btn btn-primary" data-toggle="modal"
								data-target="#confirmaexclusao"
								onclick="setaId('<%=elogio.getId()%>')">Excluir</button>
						</td>
					</tr>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<form action="DelElogios" method="POST">
		...
		<div class="row justify-content-md-center">
			<button OnClick="parent.location.href='./cadelogios'" type="submit"
