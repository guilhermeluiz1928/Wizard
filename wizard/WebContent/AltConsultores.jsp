...
<body>
	...
	<div class="container">
		...
		<form action="AltConsultores" method="POST" name="frm"
			...
			<div class="form-row">
				...
				<%
					...
					opcoes.setOpcao(request.getParameter("cargo"));
					List<Opcoes> cargo = opcoesDao.listarComOpcao(opcoes);
				%>
				...
				<div class="form-group col-md-6">
					<label class="corpo">Cargo</label> <select name="cargo"
						class="form-control">
						<option></option>
						<option selected><%=request.getParameter("cargo")%></option>
						<%
				...
				<%
					...
					opcoes.setOpcao(request.getParameter("especialidade"));
					List<Opcoes> espec = opcoesDao.listarComOpcao(opcoes);
				%>
				...
				<div class="form-group col-md-6">
					<label class="corpo">Especialidade</label> <select
						...
						<%
							if (request.getParameter("especialidade").equals("N")) {
						%>
						...
						%>
						<option></option>
						<option selected><%=request.getParameter("especialidade")%></option>
						<%
							}
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label class="corpo">Ramal</label> <input type="text"
						...
						value="<%=request.getParameter("ramal")%>">
				</div>
			...
			<div class="form-row">
				<div class="form-group col-md-3">
					<label class="corpo">Data de Nascimento</label> <input type="date"
						...
						value="<%=request.getParameter("dtnascimento")%>">
				</div>

				<div class="form-group col-md-3">
					<label class="corpo">Data de Contratação</label> <input type="date"
						class="form-control" name="dtcontratacao"
						value="<%=request.getParameter("dtcontratacao")%>">
				</div>

				<%
					Consultores consultores = new Consultores();
					ConsultoresDao consultoresDao = new ConsultoresDao();
					consultores.setNome(request.getParameter("lider"));
					List<Consultores> lstLideres = consultoresDao.listarLiderAlt(consultores);
				%>
				...
				<div class="form-group col-md-6">
					<label class="corpo">Lider de Célula</label> <select name="lider"
						class="form-control">
						<%
							if (request.getParameter("lider").equals("N")) {
						%>
						<option selected></option>
						<%
							} else {
						%>
						<option></option>
						<option selected><%=request.getParameter("lider")%></option>
						<%
							}
			...
			<div class="form-row justify-content-md-center">
				<img
					...
					src="<%=request.getParameter("foto")%>" id="previewFoto">
			</div>
			<div class="form-row justify-content-md-center">
